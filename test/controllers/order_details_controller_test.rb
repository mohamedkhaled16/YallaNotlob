...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { comment: @order_detail.comment, item: @order_detail.item, notification_id: @order_detail.notification_id, price: @order_detail.price, qty: @order_detail.qty }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { comment: @order_detail.comment, item: @order_detail.item, notification_id: @order_detail.notification_id, price: @order_detail.price, qty: @order_detail.qty }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
